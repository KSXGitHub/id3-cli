...
text!(title_json_filled3: "title" --format=json "audio3" => Some("Broken Moon"));

text!(artist_yaml_empty0: "artist" --format=yaml "audio0" => None::<&str>);
text!(artist_yaml_empty1: "artist" --format=yaml "audio1" => None::<&str>);
text!(artist_yaml_filled2: "artist" --format=yaml "audio2" => Some("ココ&さつき が てんこもり"));
text!(artist_yaml_filled3: "artist" --format=yaml "audio3" => Some("Koko & Satsuki ga Tenkomori"));
